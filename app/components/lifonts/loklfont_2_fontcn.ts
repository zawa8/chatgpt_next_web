import {
  ...
  malayalamenglosoftw8asc,
  sinhalaenglosoftw8asc,
  teluguenglosoftw8asc,
  gurmukhienglosoftw8asc,
  hindienglosoftw8asc,
  koreanenglosoftw8asc,
  oriyaenglosoftw8asc,
  tamilenglosoftw8asc,
} from "./localfonts";
...
export const loklfont_2_fontcn = (sval: string): string => {
  switch (sval) {
    ...
    case "tamilenglosoftw8asc":
      return tamilenglosoftw8asc.className;
    case "kannadaenglosoftw8asc":
      return kannadaenglosoftw8asc.className;
    case "malayalamenglosoftw8asc":
      return malayalamenglosoftw8asc.className;
    case "teluguenglosoftw8asc":
      return teluguenglosoftw8asc.className;
    case "oriyaenglosoftw8asc":
      return oriyaenglosoftw8asc.className;
    case "gurmukhienglosoftw8asc":
      return gurmukhienglosoftw8asc.className;
    case "guzratienglosoftw8asc":
      return guzratienglosoftw8asc.className;
    default:
      return hindienglosoftw8asc.className;
  }
};
