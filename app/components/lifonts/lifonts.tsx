...
export const eng115_font = localFont({
  src: "./fonts/eng115.woff2",
  display: "swap",
});
export const ing115_font = localFont({
  src: "./fonts/ing115.woff2",
  display: "swap",
});
export const hingl115_font = localFont({
  src: "./fonts/hingl115.woff2",
  display: "swap",
});
export const hingu115_font = localFont({
  src: "./fonts/hingu115.woff2",
  display: "swap",
});
export const seg115_font = localFont({
  src: "./fonts/seg115.woff2",
  display: "swap",
});
export const hin115_font = localFont({
  src: "./fonts/hin115.woff2",
  display: "swap",
});
export const bangla115_font = localFont({
  src: "./fonts/bangla115.woff2",
  display: "swap",
});
export const telugu115_font = localFont({
  src: "./fonts/telugu115.woff2",
  display: "swap",
});
export const mlyalm115_font = localFont({
  src: "./fonts/mlyalm115.woff2",
  display: "swap",
});
export const tmil115_font = localFont({
  src: "./fonts/tmil115.woff2",
  display: "swap",
});
export const korean115_font = localFont({
  src: "./fonts/korean115.woff2",
  display: "swap",
});

export const kannada115_font = localFont({
  src: "./fonts/kannada115.woff2",
  display: "swap",
});
export const guzrati115_font = localFont({
  src: "./fonts/guzrati115.woff2",
  display: "swap",
});
export const gurmukhi115_font = localFont({
  src: "./fonts/gurmukhi115.woff2",
  display: "swap",
});
export const odia115_font = localFont({
  src: "./fonts/odia115.woff2",
  display: "swap",
});
export const sinhala115_font = localFont({
  src: "./fonts/sinhala115.woff2",
  display: "swap",
});
export const hex115_font = localFont({
  src: "./fonts/hex115.woff2",
  display: "swap",
});
export const binaryvertical115_font = localFont({
  src: "./fonts/binaryvertical115.woff2",
  display: "swap",
});
export const binaryhoriontal115_font = localFont({
  src: "./fonts/binaryhoriontal115.woff2",
  display: "swap",
});
export const hscii115_font = localFont({
  src: "./fonts/hscii115.woff2",
  display: "swap",
});
...
const FontPicker: React.FC = () => {
  const handlevaluechange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const v_to_f = (sval: string): string => {
      switch (sval) {
        case "0":
          return hingu115_font.className;
        case "1":
          return hin115_font.className;
        case "2":
          return hingl115_font.className;
        case "3":
          return ing115_font.className;
        case "4":
          return sinhala115_font.className;
        case "5":
          return korean115_font.className;
        case "6":
          return tmil115_font.className;
        case "7":
          return kannada115_font.className;
        case "8":
          return mlyalm115_font.className;
        case "9":
          return telugu115_font.className;
        case "L":
          return odia115_font.className;
        case "J":
          return bangla115_font.className;
        case "B":
          return gurmukhi115_font.className;
        case "W":
          return hex115_font.className;
        case "E":
          return guzrati115_font.className;
        case "F":
          return eng115_font.className;
        case "10":
          return hscii115_font.className;
        case "11":
          return seg115_font.className;
        case "12":
          return binaryvertical115_font.className;
        default:
          return seg115_font.className;
      }
    };
